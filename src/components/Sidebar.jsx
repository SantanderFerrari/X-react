...
export default function Sidebar() {
    ...
    return (
        <div className="flex flex-col justify-between fixed h-screen p-3">
  ...
  transition-all duration-200 w-48 h-9 hidden xl:inline"
            ...
            </div>
            {
                session && (
                    <div
                        className="p-3 fixed bottom-0 left-0 w-full flex text-gray-700 text-sm items-center cursor-pointer hover:bg-slate-200 rounded-full transition-all duration-200"
                    >
                        <img
